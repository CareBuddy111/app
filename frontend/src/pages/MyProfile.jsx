...
const MyProfile = () => {
  ...
  const [userData,setUserData] = useState({
    name:"Sharafa Wale Mustapha",
    image:assets.profile_pic,
    email:"mustaphasharafa70@gmail.com",
    phone:"+234 90 2537 5109",
    address:{
      line1:"bariga lagoslagos",
      line2:"ikorodu lagos"
  ...
  return (
    <div className='max-w-ig flex flex-col gap-2 text-sm'>
        ...
        <hr className='bg-zinc-400 h-[1px] broder-none'/>

        <div>
          <p className='text-neutral-500 underline  mt-3'>CONTACT INFORMATION</p>
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-n'>
